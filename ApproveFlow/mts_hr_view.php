                    ...
                    <tbody>
                        <?php
                                ...
                                foreach ($rows as $row) {
                                    ...
                                    if ($row['mtsAP_role'] == 4) {
                                        echo $table.'<td><a class="btn btn-success btn-xl" href="../ApproveFlow/mts_hr_check.php?doc_id=' . $row["Document_num"] . '" ><i class="ti-zoom-in"></i> View</a></td></tr>';
                                    }elseif($row['mtsAP_role'] == 5) {
                                        echo $table.'<td><a class="btn btn-success btn-xl" href="../ApproveFlow/mts_hr_approve.php?doc_id=' . $row["Document_num"] . '" ><i class="ti-zoom-in"></i> View</a></td></tr>';
                                    }
                                }
