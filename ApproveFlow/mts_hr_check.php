            ...
            <div class="pull-right">
                <?php
                        if ($row1['Form_ID'] == '2') {
                            ...
                            echo '<a class="btn btn-success btn-mb" name="app" id="app" onclick="approveuser(this.id)">Send</a>
                            <a class="btn btn-danger btn-mb" name="rej" id="rej" onclick="approveuser(this.id)">Rejected</a>';    
                        }else{
