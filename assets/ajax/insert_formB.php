...
(Emp_ID, Personal_grade, Position_name, Department_ID, Sectioncode_ID, Section_type, CostCenter_ID, Shift_ID, Supervisor_Code, reason_tranfer, Document_num)
VALUES (:Emp_ID, :mts_psn_gr, :mts_pon_name, :mts_dp_name, :mts_scc_id, :mts_sc_type, :mts_cc_id, :mts_sf_name, :Supervisor_Code, :reason, $num);

INSERT INTO mts_previousinfo
(Emp_ID, Personal_grade, Position_name, Department_ID, Section, Sectioncode_ID, Section_type, CostCenter_ID, Shift_ID, Document_num) 
VALUES (:Emp_ID, :psn_gr, :pos_name, :dp_name, :sc_name, :sc_code, :sc_type, :CostCenter_ID, :shift, $num);
...
VALUES (:CHQ1, '1', '1', '1' ,$num),(:CHQ2, '2', '0', '1' ,$num),(:AP, '3', '0', '1' ,$num);
