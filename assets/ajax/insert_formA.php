...
//: เพิ่มลำดับฟอร์ม
$fetch_num = $connDB_MTS->query("SELECT MAX(Document_num) FROM mts_document");
$row_num = $fetch_num->fetch_array();
$num = $row_num['MAX(Document_num)']+1;


$query = "
INSERT INTO MTS_employee
(Emp_ID, Personal_grade, Position_name, Sectioncode_ID, Section_type, CostCenter_ID, Shift_ID, Supervisor_Code, reason_tranfer, Document_num)
VALUES (:Emp_ID, :mts_psn_gr, :mts_pon_name, :mts_scc_id, :mts_sc_type, :mts_cc_id, :mts_sf_name, :Supervisor_Code, :reason, $num);

INSERT INTO mts_previousinfo
(Emp_ID, Personal_grade, Position_name, Section, Sectioncode_ID, Section_type, CostCenter_ID, Shift_ID, Document_num) 
VALUES (:Emp_ID, :psn_gr, :pos_name, :sc_name, :sc_code, :sc_type, :CostCenter_ID, :shift, $num);

INSERT INTO mts_document
(Document_num, Form_ID, Create_by, EFF_Date)
VALUES ($num, :form_type, :create, :eff_date);

INSERT INTO mts_apf
(mtsAP_empid, mtsAP_step, mtsAP_status, mtsAP_group, mtsAP_doc)
VALUES (:CHQ, '1', '1', '1' ,$num),(:AP, '2', '0', '1' ,$num);
