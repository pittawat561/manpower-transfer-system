...
(Emp_ID, mts_Personal_grade, mts_Position_name, mts_Sectioncode_ID, mts_Section_type, mts_CostCenter_ID, mts_Shift_ID, Supervisor_Code, reason_tranfer, Document_num)
VALUES (:Emp_ID, :mts_psn_gr, :mts_pon_name, :mts_scc_id, :mts_sc_type, :mts_cc_id, :mts_sf_name, :Supervisor_Code, :reason, :form_number);

INSERT INTO mts_previousinfo
(Emp_ID, Personal_grade, Position_name, Sectioncode_ID, Section_type, CostCenter_ID, Shift_ID, Document_num) 
VALUES (:Emp_ID, :psn_gr, :pos_name, :sc_code, :sc_type, :CostCenter_ID, :shift, :form_number);
...
VALUES (:CHQ, '1', '1', '1', :form_number, '1'),(:AP, '2', '0', '1', :form_number, '1');
