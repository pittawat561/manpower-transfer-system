...
(Emp_ID, mts_Personal_grade, mts_Position_name, mts_Company_ID, mts_Department_ID, mts_Sectioncode_ID, mts_Section_type, mts_CostCenter_ID, mts_Shift_ID, Supervisor_Code, reason_tranfer, Document_num)
VALUES (:Emp_ID, :mts_psn_gr, :mts_pon_name, :mts_com,:mts_dp_name, :mts_scc_id, :mts_sc_type, :mts_cc_id, :mts_sf_name, :Supervisor_Code, :reason, :form_number);

INSERT INTO mts_previousinfo
(Emp_ID, Personal_grade, Position_name, Company_ID,Department_ID, Sectioncode_ID, Section_type, CostCenter_ID, Shift_ID, Document_num) 
VALUES (:Emp_ID, :psn_gr, :pos_name, :com,:dp_name, :sc_code, :sc_type, :CostCenter_ID, :shift, :form_number);
...
VALUES (:CHQ1, '1', '1', '1' ,:form_number, '1'),(:CHQ2, '2', '0', '1' ,:form_number, '1'),(:AP, '3', '0', '1' ,:form_number, '1');
...
{ 
	...
	$data = array(
        ...
        ':com'			      	    =>	$_POST['hidden_company'][$count],
        ':dp_name'                  =>  $dep,
        ...
        ':mts_com'			      	=>	$_POST['hidden_mts_company'][$count],
        ':mts_dp_name'              =>  $dep_new,
