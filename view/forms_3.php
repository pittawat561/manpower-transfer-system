...
<div class="container-fluid px-4 animated fadeInUp">
    <ol class="breadcrumb">
        <li>Home</li>
        <li>Forms</li>
        <li class="active">ฟอร์มย้ายคนข้ามบริษัท</li>
    </ol>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="post" id="FORM3">
                ...
                <input type="hidden" name="form_number" id="form_number" value="<?php echo $formC_number; ?>">
                <input type="hidden" name="form_type" id="form_type" value="3" readonly>
            ...
            <form class="grid-form">
                <fieldset>
                    ...
                    <div data-row-span="4">
                        ...
                        <div data-field-span="1">
                            <label>บริษัท</label>
                            <input class="input-sm text-left" type="text" name="company" id="company" readonly>
                        </div>
                        <div data-field-span="1">
                            <label>แผนก</label>
                    ...
                    <div data-row-span="4">
                        ...
                        <div data-field-span="1">
                            <label>บริษัท <span id="error_mts_company" class="text-danger1"></span></label>
                            <select name="mts_company" id="mts_company" required>
                                <option value=""> บริษัท </option>
                                <option value="SDM">Siam DENSO Manufacturing</option>
                                <option value="SKD">Siam KYOSAN DENSO</option>
                            </select>
                        </div>
                        <div data-field-span="1">
                            <label>แผนก <span id="error_mts_dp_name" class="text-danger1"></span></label>
                            <select name="mts_dp_name" id="mts_dp_name" required>
                    ...
                    <div data-row-span="4">
                        <div data-field-span="1">
                            ...
                            <select name="mts_sf_name" id="mts_sf_name" required>
                                ...
                                <?php
                                $sql = "SELECT DISTINCT Shift_name FROM shift order by Shift_name";
                                $hand = mysqli_query($connDB_DBMC, $sql);
                                while ($row = mysqli_fetch_array($hand)) {
                                ?>
                                <option value="<?= $row["Shift_name"] ?>">
                                    <?= $row["Shift_name"] ?>
                                </option>
                                <?php } ?>
                            </select>
...
<script src="../assets/plugin/datatables/MTSFM3.js"></script>
...
$(document).ready(function() {
    ...
    $("#mts_company").select2({
        ajax: {
            url: "../assets/ajax/select2_com.php",
            type: "POST",
            dataType: 'json',
            delay: 250,
            data: function(params) {
    ...
    //: select2 [ เลือกแผนก ] > ส่งค่าไป #mts_scc_id
    $("#mts_dp_name").select2({
        ajax: {
            url: "../assets/ajax/select2.atf-dep.php",
            type: "POST",
            dataType: 'json',
            delay: 250,
            data: function(params) {
                return {
                    COM_ID: $("#mts_company").val()
                };
            },
            processResults: function(response) {
                return {
    ...
    //: select2 [ รหัสหน่วยงาน ] mts_scc_id
    $("#mts_scc_id").select2({
        ajax: {
    ...
    //# AUTOFILL [ เลือกรหัสหน่วยงาน ชื่อหน่วยงานจะขึ้น Auto]
    ...
    //# AUTOFILL [ เลือกรหัสหัวหน้างาน ชื่อหัวหน้างานจะขึ้น Auto]
